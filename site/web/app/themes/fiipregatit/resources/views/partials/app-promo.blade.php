      ...
      <div class="col">
        ...
        <div class="app-intro">
          ...
          <div class="row">
            <div class="col">
              <a
                href="https://dsu.app.link/IOSfiipregatit"
                rel="nofollow"
                target="_blank">
                <img src="@asset('images/ios-badge.svg')" alt="Descărcați de pe App Store"/>
              </a>
            </div>
            <div class="col">
              <a
                href=" https://dsu.app.link/Androidfiipregatit"
                rel="nofollow"
                target="_blank">
                <img
                  class="play-store"
                  src="@asset('images/playstore-badge.svg')"
                  alt="Descărcați de pe Google Play"
                />
              </a>
            </div>
          </div>
